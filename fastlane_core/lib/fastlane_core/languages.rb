module FastlaneCore
  module Languages
    ...
    ALL_LANGUAGES = ["da", "de-AT", "de-CH", "de-DE", "el", "en-AU", "en-CA", "en-GB", "en-US", "es-ES", "es-MX", "fi", "fr-CA", "fr-FR", "id", "it", "it-CH", "it-IT", "ja", "ko", "ms", "nl-NL", "no", "pt-BR", "pt-PT", "ru", "sv", "th", "tr", "vi", "zh-Hans", "zh-Hant"]
  end
end
